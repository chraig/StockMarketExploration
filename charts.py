...
def bollinger_trace(df, fig, window_size=10, num_of_std=5):
    ...
    trace = go.Scatter(
        x=df.index, y=upper_band, mode="lines", showlegend=True, name="BB_upper"
    )

    trace2 = go.Scatter(
        x=df.index, y=rolling_mean, mode="lines", showlegend=True, name="BB_mean"
    )

    trace3 = go.Scatter(
        x=df.index, y=lower_band, mode="lines", showlegend=True, name="BB_lower"
    )
...
def accumulation_trace(df):
    ...
    trace = go.Scatter(
        x=df.index, y=df["volume"], mode="lines", showlegend=True, name="Accumulation"
    )
    return trace
...
def cci_trace(df, n_days=20):
    ...
    trace = go.Scatter(x=df.index, y=cci, mode="lines", showlegend=True, name="CCI")
    return trace
...
def roc_trace(df, n_days=5):
    ...
    trace = go.Scatter(x=df.index, y=roc, mode="lines", showlegend=True, name="ROC")
    return trace
...
def stoc_trace(df):
    ...
    trace = go.Scatter(x=df.index, y=so_k, mode="lines", showlegend=True, name="SO%k")
    return trace
...
def mom_trace(df, n=5):
    ...
    trace = go.Scatter(x=df.index, y=m, mode="lines", showlegend=True, name="MOM")
    return trace
...
def pp_trace(df, fig):
    ...
    trace = go.Scatter(x=df.index, y=pp, mode="lines", showlegend=True, name="PP")
    trace1 = go.Scatter(x=df.index, y=r1, mode="lines", showlegend=True, name="R1")
    trace2 = go.Scatter(x=df.index, y=s1, mode="lines", showlegend=True, name="S1")
    trace3 = go.Scatter(x=df.index, y=r2, mode="lines", showlegend=True, name="R2")
    trace4 = go.Scatter(x=df.index, y=s2, mode="lines", showlegend=True, name="S2")
    trace5 = go.Scatter(x=df.index, y=r3, mode="lines", showlegend=True, name="R3")
    trace6 = go.Scatter(x=df.index, y=s3, mode="lines", showlegend=True, name="S3")
